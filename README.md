...
### Application UI
Full page screengrab of the application.
...
### Upload Screen
Upload interface for submitting claim data.
...
### Parsed Claim JSON
Parsed claim JSON output generated by the system.

![Parsed Claim Data](screenshots/parsed-data.png)

---

### Denial Explanation
AI generated denial explanation for the claim.

![Denial Explanation](screenshots/explanation.png)

---

### Generated Appeal Letter
Automatically generated appeal letter for denied claims.

![Appeal Letter](screenshots/appeal-letter.png)
